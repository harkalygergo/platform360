...
#[ORM\Entity(repositoryClass: WebsiteCategoryRepository::class)]
class WebsiteCategory
{
    ...
    public function addPost(WebsitePost $post): self
    {
    ...
    public function removePost(WebsitePost $post): self
    {
